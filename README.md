...
- **[falcosecurity/rules](https://github.com/falcosecurity/rules)** (188 ⭐) — _Falco rule repository_<br>&nbsp;&nbsp;✅ 1 merged · merged diff **+93 / −0**
...
| [falcosecurity/rules](https://github.com/falcosecurity/rules) | 188 | [#373](https://github.com/falcosecurity/rules/pull/373) new(rules): detect GPU/accelerator cryptojacking and device access … | +93 / −0 | ✅ Merged |
