...
<!-- merged-badge:start -->
<img src="https://img.shields.io/badge/OSS_Merged_PRs-9-d4a24c?style=for-the-badge&logo=github&logoColor=d4a24c&labelColor=0a0f22">
<img src="https://img.shields.io/badge/Across-4_security_projects-0a0f22?style=for-the-badge&labelColor=0a0f22">
<!-- merged-badge:end -->
...
<!-- contributions:start -->
**9 merged · 8 in review · 2 closed** across **8** external project(s).
...
- **[GRCEngClub/claude-grc-engineering](https://github.com/GRCEngClub/claude-grc-engineering)** (307 ⭐) — _Open-source GRC toolkit from the GRC Engineering Club. Claude Code plugins for evidence collection, SCF crosswalks, multi-framework gap reports, OSCAL workflows._<br>&nbsp;&nbsp;✅ 2 merged · ⚪ 1 closed · merged diff **+1,698 / −7**
...
- **[NVIDIA/garak](https://github.com/NVIDIA/garak)** (8.1K ⭐) — _the LLM vulnerability scanner_<br>&nbsp;&nbsp;🟡 2 in review
...
| [GRCEngClub/claude-grc-engineering](https://github.com/GRCEngClub/claude-grc-engineering) | 307 | [#72](https://github.com/GRCEngClub/claude-grc-engineering/pull/72) feat(frameworks): Reference-depth India DPDPA plugin (ind-dpdpa) | +1,425 / −0 | ✅ Merged |
| [GRCEngClub/claude-grc-engineering](https://github.com/GRCEngClub/claude-grc-engineering) | 307 | [#71](https://github.com/GRCEngClub/claude-grc-engineering/pull/71) ci(plugins): validate manifests against JSON Schema on every PR | +273 / −7 | ✅ Merged |
...
| [NVIDIA/garak](https://github.com/NVIDIA/garak) | 8.1K | [#1859](https://github.com/NVIDIA/garak/pull/1859) fix(openai): catch AuthenticationError before multiprocessing pickl… | +107 / −0 | 🟡 In review |
...
| [GRCEngClub/claude-grc-engineering](https://github.com/GRCEngClub/claude-grc-engineering) | 307 | [#70](https://github.com/GRCEngClub/claude-grc-engineering/pull/70) fix(plugins): use object form for plugin.json author field | +7 / −7 | ⚪ Closed |
