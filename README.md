...
<a href="https://devamshah.github.io/"><img src="https://img.shields.io/badge/Portfolio-devamshah.github.io-d4a24c?style=for-the-badge&labelColor=0a0f22"></a>
<a href="https://www.linkedin.com/in/thedevam/"><img src="https://img.shields.io/badge/LinkedIn-%40thedevam-0a0f22?style=for-the-badge&logo=linkedin&logoColor=d4a24c&labelColor=0a0f22"></a>
...
<!-- merged-badge:start -->
<img src="https://img.shields.io/badge/OSS_Merged_PRs-19-d4a24c?style=for-the-badge&logo=github&logoColor=d4a24c&labelColor=0a0f22">
...
<!-- contributions:start -->
**19 merged · 24 in review · 6 closed** across **31** external project(s).

### Projects with accepted contributions

- **[projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates)** (12.7K ⭐) — _Community curated list of templates for the nuclei engine to find security vulnerabilities._<br>&nbsp;&nbsp;✅ 6 merged · 🟡 2 in review · ⚪ 1 closed · merged diff **+154 / −66**
- **[Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** (4.1K ⭐) — _A full-stack AI Red Teaming platform securing AI ecosystems via OpenClaw Security Scan, Agent Scan, Skills Scan, MCP scan, AI Infra scan and LLM jailbreak evaluation._<br>&nbsp;&nbsp;✅ 2 merged · 🟡 1 in review · merged diff **+651 / −0**
- **[GRCEngClub/claude-grc-engineering](https://github.com/GRCEngClub/claude-grc-engineering)** (343 ⭐) — _Open-source GRC toolkit from the GRC Engineering Club. Claude Code plugins for evidence collection, SCF crosswalks, multi-framework gap reports, OSCAL workflows._<br>&nbsp;&nbsp;✅ 2 merged · ⚪ 1 closed · merged diff **+1,698 / −7**
- **[ReversecLabs/spikee](https://github.com/ReversecLabs/spikee)** (222 ⭐) — _Simple Prompt Injection Kit for Evaluation and Exploitation_<br>&nbsp;&nbsp;✅ 2 merged · 🟡 1 in review · merged diff **+199 / −2**
...
- **[KeygraphHQ/shannon](https://github.com/KeygraphHQ/shannon)** (45.8K ⭐) — _Shannon is an autonomous, white-box AI pentester for web applications and APIs. It analyzes your source code, identifies attack vectors, and executes real exploits to prove vulnerabilities before they reach production._<br>&nbsp;&nbsp;🟡 1 in review
- **[projectdiscovery/nuclei](https://github.com/projectdiscovery/nuclei)** (29.8K ⭐) — _Nuclei is a fast, customizable vulnerability scanner powered by the global security community and built on a simple YAML-based DSL, enabling collaboration to tackle trending vulnerabilities on the internet. It helps you find vulnerabilities in your applications, APIs, networks, DNS, and cloud configurations._<br>&nbsp;&nbsp;🟡 1 in review
- **[gitleaks/gitleaks](https://github.com/gitleaks/gitleaks)** (28.2K ⭐) — _Find secrets with Gitleaks 🔑_<br>&nbsp;&nbsp;🟡 2 in review
- **[blacklanternsecurity/bbot](https://github.com/blacklanternsecurity/bbot)** (10.2K ⭐) — _The recursive internet scanner for hackers. 🧡_<br>&nbsp;&nbsp;🟡 1 in review
...
- **[ossf/scorecard](https://github.com/ossf/scorecard)** (5.6K ⭐) — _OpenSSF Scorecard - Security health metrics for Open Source_<br>&nbsp;&nbsp;🟡 1 in review
...
- **[confident-ai/deepteam](https://github.com/confident-ai/deepteam)** (2.2K ⭐) — _DeepTeam is a framework to red team LLMs and AI agents._<br>&nbsp;&nbsp;🟡 1 in review
...
- **[trailofbits/fickling](https://github.com/trailofbits/fickling)** (649 ⭐) — _A Python pickling decompiler and static analyzer_<br>&nbsp;&nbsp;🟡 1 in review
- **[ossf/malicious-packages](https://github.com/ossf/malicious-packages)** (572 ⭐) — _A repository of reports of malicious packages identified in Open Source package repositories, consumable via the Open Source Vulnerability (OSV) format._<br>&nbsp;&nbsp;🟡 1 in review
...
- **[sigstore/model-transparency](https://github.com/sigstore/model-transparency)** (238 ⭐) — _Supply chain security for ML_<br>&nbsp;&nbsp;🟡 1 in review
...
- **[falcosecurity/rules](https://github.com/falcosecurity/rules)** (181 ⭐) — _Falco rule repository_<br>&nbsp;&nbsp;🟡 1 in review
...
|---|---:|---|---:|---|
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16053](https://github.com/projectdiscovery/nuclei-templates/pull/16053) fix(tomcat-default-login): order payloads to dodge LockOutRealm (FN) | +51 / −55 | ✅ Merged |
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16055](https://github.com/projectdiscovery/nuclei-templates/pull/16055) add: LiteLLM proxy unauthenticated /model/info exposure | +51 / −0 | ✅ Merged |
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16385](https://github.com/projectdiscovery/nuclei-templates/pull/16385) dns: add internal IP address disclosure in DNS A records | +42 / −0 | ✅ Merged |
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16056](https://github.com/projectdiscovery/nuclei-templates/pull/16056) add: ChromaDB unauthenticated collections API exposure | +9 / −3 | ✅ Merged |
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16050](https://github.com/projectdiscovery/nuclei-templates/pull/16050) fix: drop clear-site-data matcher from http-missing-security-header… | +0 / −7 | ✅ Merged |
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16052](https://github.com/projectdiscovery/nuclei-templates/pull/16052) fix(CVE-2021-40438): support custom interactsh server hostnames (FN) | +1 / −1 | ✅ Merged |
| [redcanaryco/atomic-red-team](https://github.com/redcanaryco/atomic-red-team) | 12.2K | [#3370](https://github.com/redcanaryco/atomic-red-team/pull/3370) Add T1567.004 - Exfiltration Over Webhook (Discord/Slack/Teams) | +111 / −0 | ✅ Merged |
| [NVIDIA/garak](https://github.com/NVIDIA/garak) | 8.5K | [#1859](https://github.com/NVIDIA/garak/pull/1859) fix: catch OpenAI AuthenticationError before multiprocessing pickle | +107 / −0 | ✅ Merged |
...
| [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) | 4.1K | [#427](https://github.com/Tencent/AI-Infra-Guard/pull/427) feat(eval): add agentic-tool-misuse evaluation dataset | +384 / −0 | ✅ Merged |
| [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) | 4.1K | [#424](https://github.com/Tencent/AI-Infra-Guard/pull/424) feat(data): add 6 llama.cpp CVE rules (RPC RCE + GGUF/tokenizer mem… | +267 / −0 | ✅ Merged |
...
| [vulnerability-lookup/vulnerability-lookup](https://github.com/vulnerability-lookup/vulnerability-lookup) | 547 | [#431](https://github.com/vulnerability-lookup/vulnerability-lookup/pull/431) new: [perf] add pg_trgm GIN indexes for sighting source/vulnerabili… | +50 / −0 | ✅ Merged |
...
| [GRCEngClub/claude-grc-engineering](https://github.com/GRCEngClub/claude-grc-engineering) | 343 | [#72](https://github.com/GRCEngClub/claude-grc-engineering/pull/72) feat(frameworks): Reference-depth India DPDPA plugin (ind-dpdpa) | +1,425 / −0 | ✅ Merged |
| [GRCEngClub/claude-grc-engineering](https://github.com/GRCEngClub/claude-grc-engineering) | 343 | [#71](https://github.com/GRCEngClub/claude-grc-engineering/pull/71) ci(plugins): validate manifests against JSON Schema on every PR | +273 / −7 | ✅ Merged |
...
| [ReversecLabs/spikee](https://github.com/ReversecLabs/spikee) | 222 | [#109](https://github.com/ReversecLabs/spikee/pull/109) feat: add homoglyph encoding plugin (Unicode confusables) | +197 / −0 | ✅ Merged |
| [ReversecLabs/spikee](https://github.com/ReversecLabs/spikee) | 222 | [#111](https://github.com/ReversecLabs/spikee/pull/111) docs: fix GOAT citation and note workspace-only status in 02_builti… | +2 / −2 | ✅ Merged |
| [KeygraphHQ/shannon](https://github.com/KeygraphHQ/shannon) | 45.8K | [#322](https://github.com/KeygraphHQ/shannon/pull/322) Security hardening, CLI bug fixes, and SARIF report output | +1,677 / −40 | 🟡 In review |
| [projectdiscovery/nuclei](https://github.com/projectdiscovery/nuclei) | 29.8K | [#7495](https://github.com/projectdiscovery/nuclei/pull/7495) feat(reporting): add CSV result exporter (-csv-export) | +294 / −0 | 🟡 In review |
| [gitleaks/gitleaks](https://github.com/gitleaks/gitleaks) | 28.2K | [#2177](https://github.com/gitleaks/gitleaks/pull/2177) feat(rules): add Pinecone and LangSmith API key detection rules | +89 / −0 | 🟡 In review |
| [gitleaks/gitleaks](https://github.com/gitleaks/gitleaks) | 28.2K | [#2178](https://github.com/gitleaks/gitleaks/pull/2178) feat(rules): add Anthropic OAuth refresh token rule (sk-ant-ort01-) | +36 / −0 | 🟡 In review |
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16386](https://github.com/projectdiscovery/nuclei-templates/pull/16386) add: Qdrant vector database - unauthenticated collections exposure | +48 / −0 | 🟡 In review |
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16051](https://github.com/projectdiscovery/nuclei-templates/pull/16051) fix(CVE-2025-58360): switch GeoServer XXE detection to OAST (FN on … | +15 / −8 | 🟡 In review |
| [redcanaryco/atomic-red-team](https://github.com/redcanaryco/atomic-red-team) | 12.2K | [#3359](https://github.com/redcanaryco/atomic-red-team/pull/3359) Add T1213.005 - Data from Information Repositories: Messaging Appli… | +187 / −0 | 🟡 In review |
| [blacklanternsecurity/bbot](https://github.com/blacklanternsecurity/bbot) | 10.2K | [#3235](https://github.com/blacklanternsecurity/bbot/pull/3235) excavate: add AIApplicationExtractor for LLM endpoints, SDKs, and l… | +202 / −0 | 🟡 In review |
...
| [ossf/scorecard](https://github.com/ossf/scorecard) | 5.6K | [#5103](https://github.com/ossf/scorecard/pull/5103) checks/sast: detect Semgrep, Bandit, and gosec SAST workflows | +162 / −0 | 🟡 In review |
...
| [Tencent/AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard) | 4.1K | [#429](https://github.com/Tencent/AI-Infra-Guard/pull/429) feat(agent-scan): add memory/RAG poisoning detection skill | +177 / −0 | 🟡 In review |
| [confident-ai/deepteam](https://github.com/confident-ai/deepteam) | 2.2K | [#236](https://github.com/confident-ai/deepteam/pull/236) feat(attacks): add Caesar, Morse, hex, zero-width & homoglyph encod… | +859 / −1 | 🟡 In review |
...
| [trailofbits/fickling](https://github.com/trailofbits/fickling) | 649 | [#283](https://github.com/trailofbits/fickling/pull/283) Add recursive directory and glob scanning to the CLI for bulk pickl… | +330 / −1 | 🟡 In review |
| [ossf/malicious-packages](https://github.com/ossf/malicious-packages) | 572 | [#1329](https://github.com/ossf/malicious-packages/pull/1329) docs: add a consumer guide for using the reports | +235 / −0 | 🟡 In review |
...
| [sigstore/model-transparency](https://github.com/sigstore/model-transparency) | 238 | [#642](https://github.com/sigstore/model-transparency/pull/642) feat: Add in-memory signing API returning the Sigstore bundle as bytes | +130 / −4 | 🟡 In review |
...
| [ReversecLabs/spikee](https://github.com/ReversecLabs/spikee) | 222 | [#110](https://github.com/ReversecLabs/spikee/pull/110) feat(judges): add secret_leak judge for credential/PII exfiltration… | +324 / −0 | 🟡 In review |
| [falcosecurity/rules](https://github.com/falcosecurity/rules) | 181 | [#373](https://github.com/falcosecurity/rules/pull/373) new(rules): detect GPU/accelerator cryptojacking and device access … | +81 / −0 | 🟡 In review |
...
| [projectdiscovery/nuclei-templates](https://github.com/projectdiscovery/nuclei-templates) | 12.7K | [#16054](https://github.com/projectdiscovery/nuclei-templates/pull/16054) add: Langflow unauthenticated flow API exposure detection | +80 / −0 | ⚪ Closed |
| [NVIDIA/garak](https://github.com/NVIDIA/garak) | 8.5K | [#1858](https://github.com/NVIDIA/garak/pull/1858) probes: add many-shot jailbreaking probe | +195 / −0 | ⚪ Closed |
...
| [GRCEngClub/claude-grc-engineering](https://github.com/GRCEngClub/claude-grc-engineering) | 343 | [#70](https://github.com/GRCEngClub/claude-grc-engineering/pull/70) fix(plugins): use object form for plugin.json author field | +7 / −7 | ⚪ Closed |
